...
export const createTicketServiceSchema = Joi.object({
  ...
  equipment_type: Joi.string().max(255).optional().allow(null, ''),
  equipment_model: Joi.string().max(255).optional().allow(null, ''),
  outdoor_modal_no: Joi.string().max(50).optional().allow(null, ''),
  outdoor_serial_no: Joi.string().max(50).optional().allow(null, ''),
  indoor_modal_no: Joi.string().max(50).optional().allow(null, ''),
  indoor_serial_no: Joi.string().max(50).optional().allow(null, ''),
